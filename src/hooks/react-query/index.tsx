...
type UseGlobalQueryParameterObjectType<T, K, D> = {
  ...
  key: string;
  params?: T;
  options?: Omit<UseQueryOptions<AxiosResponse<K>, AxiosError, D>, "queryKey" | "queryFn">;
  segment?: string;
};

const useGlobalQuery = <T, K, D = K>({ URL, key, params, options, segment }: UseGlobalQueryParameterObjectType<T, K, D>) => {
